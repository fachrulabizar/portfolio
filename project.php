						...
						<a href="" data-toggle="modal" data-target="#exampleModalCenter1">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									...
									<h4 class="title" style="color:#5E5C7F">WEBSITE METECHSO</h4>
								</div>
								<div class="thumb">
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content rounded">
									...
									<div class="modal-body">
                                        ...
                                        <p>Sebuah website perusahaan PT. Medang Technology Solution</p>
										<a href="https://metechso.com/" target="_blank" class="btn btn-default">View Website</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter2">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">E-RECRUITMENT WEBSITE</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter3">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">PERSONAL WEBSITE</h4>
								</div>
								<div class="thumb">
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content rounded">
									...
									<div class="modal-body">
                                        ...
                                        <p>Website portfolio yang menjelaskan perjalanan karir saya</p>
										<a href="https://fachrulabizar.metechso.com/" target="_blank" class="btn btn-default">View Website</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter4">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Local Server</span>
									<h4 class="title" style="color:#5E5C7F">Local Server</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter5">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">APP STOK BARANG</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter6">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">IT Infrastructure</span>
									<h4 class="title" style="color:#5E5C7F">IT Infrastructure</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter7">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">APP Penggajian</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter8">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">APP HELPDESK TICKETING</h4>
								</div>
								<div class="thumb">
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content rounded">
									...
									<div class="modal-body">
                                        ...
                                        <p>Aplikasi untuk melaporkan barang yang trouble diperuntukan untuk client PT. Medang Technology Solution</p>
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter9">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">PMB</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter10">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">SISTEM PAKAR</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter11">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">SISTEM PENUNJANG KEPUTUSAN</h4>
								</div>
								<div class="thumb">
					...
					<div class="col-md-4 col-sm-6 grid-item creative design">
						<a href="" data-toggle="modal" data-target="#exampleModalCenter12">
							<div class="portfolio-item rounded shadow-blue">
								<div class="details">
									<span class="term">Website</span>
									<h4 class="title" style="color:#5E5C7F">E-Commerce Wahana Sukses Makmur</h4>
								</div>
								<div class="thumb">
